import 'bloc/score_one_bloc.dart';
import 'models/score_one_model.dart';
...
class ScoreOneScreen extends StatelessWidget {
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<ScoreOneBloc>(
        create: (context) =>
            ScoreOneBloc(ScoreOneState(scoreOneModelObj: ScoreOneModel()))
              ..add(ScoreOneInitialEvent()),
        child: ScoreOneScreen());
  }

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<ScoreOneBloc, ScoreOneState>(builder: (context, state) {
      return SafeArea(
          child: Scaffold(
              ...
              appBar: CustomAppBar(
                  ...
                  actions: [
                    AppbarImage(
                        ...
                        margin:
                            getMargin(left: 25, top: 8, right: 25, bottom: 8))
                  ]),
              body: Container(
                      ...
                      children: [
                        Align(
                            ...
                            child: Container(
                                ...
                                child: Text("msg_we_re_analyzing_the".tr,
                                    maxLines: null,
